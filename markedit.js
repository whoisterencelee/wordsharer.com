...
function Lexer(options) {
  this.tokens = [];
  this.tokens.links = {};
  this.options = options || markedit.defaults;
...
function markedit(src, opt, callback) {
  if (callback || typeof opt === 'function') {
    ...
    opt = merge({}, markedit.defaults, opt || {});
...
markedit.options =
markedit.setOptions = function(opt) {
  merge(markedit.defaults, opt);
  return markedit;
};
...
markedit.Parser = Parser;
markedit.parser = Parser.parse;

markedit.Renderer = Renderer;

markedit.Lexer = Lexer;
markedit.lexer = Lexer.lex;

markedit.InlineLexer = InlineLexer;
markedit.inlineLexer = InlineLexer.output;

markedit.parse = markedit;

if (typeof exports === 'object') {
  module.exports = markedit;
} else if (typeof define === 'function' && define.amd) {
  define(function() { return markedit; });
} else {
